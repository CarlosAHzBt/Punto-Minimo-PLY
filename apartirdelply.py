...
if __name__ == "__main__":
    ...
    superficie_estimada = np.median(puntos_roi[:, 2])  # Puedes usar median o mean según tu necesidad
    ...
    profundidad_agujero = puntos_roi[idx_punto_mas_profundo, 2] - superficie_estimada
